...
class MotionTypeInitiatorSettingsUpdateRequest
{
    public function __construct(
        ...
        public bool $supporterCanBePerson,
        public bool $supporterCanBeOrganization,
    ...
    public static function fromWebRequest(
        ...
        return new self(
            ...
            supporterCanBePerson: !empty($settingsPost['supporterCanBePerson']),
            supporterCanBeOrganization: !empty($settingsPost['supporterCanBeOrganization']),
