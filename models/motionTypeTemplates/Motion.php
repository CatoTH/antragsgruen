...
class Motion
{
    ...
    public static function doCreateMotionSections(ConsultationMotionType $motionType): void
    {
        ...
        $builder->addSection(function (?string $language): ConsultationSettingsMotionSection {
            ...
            $section->title         = \Yii::t('structure', 'preset_motion_title', [], $language);
        ...
        $builder->addSection(function (?string $language): ConsultationSettingsMotionSection {
            ...
            $section->status        = ConsultationSettingsMotionSection::STATUS_VISIBLE;
            $section->title         = \Yii::t('structure', 'preset_motion_text', [], $language);
            $section->required      = ConsultationSettingsMotionSection::REQUIRED_YES;
            $section->maxLen        = 0;
        ...
        $builder->addSection(function (?string $language): ConsultationSettingsMotionSection {
            ...
            $section->type          = ISectionType::TYPE_TEXT_SIMPLE;
            $section->status        = ConsultationSettingsMotionSection::STATUS_VISIBLE;
            $section->title         = \Yii::t('structure', 'preset_motion_reason', [], $language);
