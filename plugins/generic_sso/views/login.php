...
$action = UrlHelper::createUrl('/generic_sso/login/login');
...
echo '<button type="submit" class="btn btn-primary btn-lg btn-block ssoLoginButton" name="ssoLogin">';
...
if (!empty($description)) {
    echo '<div class="well well-sm ssoLoginHint">';
