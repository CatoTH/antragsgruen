...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    /**
     * If a section's current content was generated by a plugin (see components/SectionAutofill.php,
     * IMotionSection::markAsAutofilled()) rather than typed in by a human, returns an admin-facing
     * hint to render above its edit field. Empty string if the section isn't (or is no longer, see
     * IMotionSection::clearAutofillMarker()) marked as such.
     */
    public static function getSectionAutofillHint(IMotionSection $section): string
    {
        if ($section->getAutofillPluginId() === null) {
            return '';
        }

        return '<div class="alert alert-info alertAutofillHint">' . \Yii::t('admin', 'section_autofill_hint') . '</div>';
    }
