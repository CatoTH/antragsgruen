...
return [
    ...
    'statute_consolidated_title'        => 'Änderungen gegenüber %PREFIX%',
    'statute_textmode_vs_original'      => 'Ursprüngliche und geänderte Fassung nebeneinander',
    'statute_textmode_vs_parent'        => 'Änderungen gegenüber %PREFIX%',
    'statute_legend_intro'              => 'Diese Ansicht zeigt zwei Ebenen von Änderungen übereinander:',
    'statute_legend_sample'             => 'Text',
    'statute_legend_parent_ins'         => 'von %PREFIX% eingefügt',
    'statute_legend_parent_del'         => 'von %PREFIX% gestrichen',
    'statute_legend_own_ins'            => 'von diesem Änderungsantrag eingefügt',
    'statute_legend_own_del'            => 'von diesem Änderungsantrag gestrichen',
    'statute_legend_nested'             => 'Ineinander verschachtelte Markierungen zeigen, wo dieser Änderungsantrag die Änderungen von %PREFIX% selbst wieder ändert – etwa Text, den %PREFIX% streichen will und der hier wieder eingefügt wird.',
...
<li><strong>Änderungsantrag einbringen</strong>: Sobald sich %MIN% Unterstützer*innen gefunden haben, bekommst du eine Benachrichtigungs-E-Mail. Ab dann kannst du den Änderungsantrag offiziell einbringen. Auch danach ist es noch möglich, dass sich Unterstützer*innen für diesen Änderungsantrag eintragen.</li>
    ...
    'proposal_save_changes_post' => 'Alte Version nachträglich bearbeiten',
    ...
    'proposal_activities_title'  => 'Änderungen &amp; Kommentare',
