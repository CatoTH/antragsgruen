...
return [
    ...
    'private_notes_para_open'            => 'Private Notiz zu Absatz %NO% (%TITLE%) <span class="sr-only">öffnen</span>',
    'private_notes_para_write'           => 'Notiz zu Absatz %NO% (%TITLE%) eingeben',
    'private_notes_para_save'            => 'Private Notiz zu Absatz %NO% (%TITLE%) speichern',
