...
return [
    ...
    'activity_MOTION_PUBLISH'             => '###USER### hat den <strong>Antrag veröffentlicht</strong>',
    ...
    'activity_MOTION_SUPPORT_FINISH'      => '###USER### hat den <strong>Antrag final eingereicht</strong>',
    ...
    'activity_MOTION_NOTIFY_PROPOSAL'     => '###USER### hat die Antragsteller*in über den <strong>Verfahrensvorschlag (Version %VERSION%) benachrichtigt</strong>',
    'activity_MOTION_ACCEPT_PROPOSAL'     => '###USER### hat dem <strong>Verfahrensvorschlag (Version %VERSION%) zugestimmt</strong>',
    'activity_MOTION_ACCEPT_PROPOSAL_admin' => '###USER### gab an, dass die Antragsteller*in dem <strong>Verfahrensvorschlag (Version %VERSION%) zustimmt</strong>',
    'activity_MOTION_REJECT_PROPOSAL'     => '###USER### hat den <strong>Verfahrensvorschlag (Version %VERSION%) abgelehnt</strong>',
    'activity_MOTION_REJECT_PROPOSAL_admin' => '###USER### gab an, dass die Antragsteller*in den <strong>Verfahrensvorschlag (Version %VERSION%) ablehnt</strong>',
    'activity_MOTION_NEW_PROPOSAL'        => '###USER### hat den <strong>Verfahrensvorschlag (Version %VERSION%) angelegt</strong>',
    'activity_MOTION_SET_PROPOSAL'        => '###USER### hat den <strong>Verfahrensvorschlag (Version %VERSION%) bearbeitet</strong>',
    'activity_MOTION_SET_PROPOSAL_TEXT'   => '###USER### hat den <strong>Verfahrensvorschlags-Text (Version %VERSION%) bearbeitet</strong>',
    ...
    'activity_AMENDMENT_PUBLISH'          => '###USER### hat den <strong>Änderungsantrag ###AMENDMENT### veröffentlicht</strong>',
    ...
    'activity_AMENDMENT_NOTIFY_PROPOSAL'  => '###USER### hat die Antragsteller*in über den <strong>Verfahrensvorschlag (Version %VERSION%) benachrichtigt</strong>',
    'activity_AMENDMENT_ACCEPT_PROPOSAL'  => '###USER### hat dem <strong>Verfahrensvorschlag (Version %VERSION%) zugestimmt</strong>',
    'activity_AMENDMENT_ACCEPT_PROPOSAL_admin' => '###USER### gab an, dass die Antragsteller*in dem <strong>Verfahrensvorschlag (Version %VERSION%) zustimmt</strong>',
    'activity_AMENDMENT_REJECT_PROPOSAL'  => '###USER### hat den <strong>Verfahrensvorschlag (Version %VERSION%) abgelehnt</strong>',
    'activity_AMENDMENT_REJECT_PROPOSAL_admin' => '###USER### gab an, dass die Antragsteller*in den <strong>Verfahrensvorschlag (Version %VERSION%) ablehnt</strong>',
    'activity_AMENDMENT_NEW_PROPOSAL'     => '###USER### hat den <strong>Verfahrensvorschlag (Version %VERSION%) angelegt</strong>',
    'activity_AMENDMENT_SET_PROPOSAL'     => '###USER### hat den <strong>Verfahrensvorschlag (Version %VERSION%) bearbeitet</strong>',
    'activity_AMENDMENT_SET_PROPOSAL_TEXT' => '###USER### hat den <strong>Verfahrensvorschlags-Text (Version %VERSION%) bearbeitet</strong>',
