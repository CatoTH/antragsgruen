...
return [
    ...
    'list_supp_orga_x'            => '%NUM% Organisationen',
    ...
    'list_prop_user_rejected'     => 'Die Antragsteller*in hat den Verfahrensvorschlag abgelehnt',
    ...
    'list_functions_tags_add'     => 'Thema-Spalte hinzufügen',
    'list_functions_tags_remove'  => 'Thema-Spalte entfernen',
    'list_functions_date_add'     => 'Datums-Spalte hinzufügen',
    'list_functions_date_remove'  => 'Datums-Spalite entfernen',
    'list_functions_type_add'     => 'Typ-Spalte hinzufügen',
    'list_functions_type_remove'  => 'Typ-Spalite entfernen',
    ...
    'filter_proposal_rejected'    => 'Verfahrensvorschlag abgelehnt',
...
<small class="conPrefixHide">Antragskürzel müssen zwar weiterhin angegeben werden, damit danach sortiert werden kann, werden aber nicht mehr angezeigt.</small>',
    ...
    'con_topics'              => 'Themen',
    'con_topics_public'       => 'Antrags-Themen',
    'con_topics_amendment'    => 'Änderungsantrags-Typen',
    ...
    'con_title_multilang'     => 'Mehrsprachigkeit',
    'con_multilang_activate'  => 'Mehrsprachigkeit aktivieren (fortgeschrittene Funktion)',
    'con_multilang_activate_h' => 'Erlaubt Nutzer*innen, die Sprache dieser Seite selbst zu wählen, und Anträgen/Änderungsanträgen, Inhalte in mehreren Sprachen parallel bereitzustellen.',
    'con_multilang_languages' => 'Verfügbare Sprachen',
...
Die Benutzer*innenverwaltung unten kommt erst dann voll zur Geltung, wenn die Leserechte oder die Rechte zum Anlegen
 ...
 Anträge etc. stellen können sollen, kannst du das hiermit automatisch einstellen:',
    ...
    'siteacc_admins_userfunc'    => 'Zusätzliche Einstellungen',
    'siteacc_admins_userprivnot' => 'Private Notizen erlauben',
...
Da <strong>kein E-Mail-Versand</strong> eingerichtet ist, musst du die <strong>Passwörter</strong> hier selbst erzeugen, im Klartext eingeben und selbst an die Nutzer*innen schicken.<br><br>' .
    ...
    'motion_type_proposed_versio' => 'Automatische Versionierung von Verfahrensvorschlägen',
    ...
    'motion_type_supp_person_type' => 'Unterstützen können',
    ...
    'motion_cdeadline_amend2amend' => 'Zeiträume für Änderungsanträge zu Änderungsanträgen (ohne Angabe gilt der Zeitraum für Änderungsanträge)',
    ...
    'motion_section_language'       => 'Sprache',
    'motion_section_language_all'   => 'Alle Sprachen',
    'motion_section_language_group' => 'Sprachgruppe',
    'motion_section_language_group_p' => 'z.B. Antragstext',
    'motion_section_language_group_h' => 'Abschnitte mit derselben Sprachgruppe sind Übersetzungen voneinander und gehören zum selben Feld, nur in einer anderen Sprache.',
    'motion_section_language_warn_no_group' => 'Der Abschnitt "%SECTION%" hat eine Sprache, aber keine Sprachgruppe und wird daher nicht als Übersetzung eines anderen Abschnitts erkannt.',
    'motion_section_language_warn_duplicate' => 'Die Sprachgruppe "%GROUP%" enthält mehr als einen Abschnitt in derselben Sprache.',
    'motion_section_language_warn_mixed_types' => 'Die Sprachgruppe "%GROUP%" enthält Abschnitte unterschiedlichen Typs.',
