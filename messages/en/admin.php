...
return [
    ...
    'motion_date_created'         => 'Created',
    'motion_date_submitted'       => 'Submitted',
    'motion_date_publication'     => 'Published',
    'motion_prefix'               => ['text' => 'Signature', 'description' => 'Label for the input field where admins set a motion\'s short reference code/prefix (e.g. "A1"), not a person\'s handwritten or digital signature.'],
    ...
    'motion_status_help'          => ['text' => 'Reference', 'description' => 'Link label (preceded by an arrow icon) to external documentation explaining the available motion statuses; "Reference" as in "see reference material", not a job/character reference or a reference number.'],
    ...
    'list_supp_orga_1'            => '%NUM% Organization',
    'list_supp_orga_x'            => '%NUM% Organizations',
    ...
    'list_title'                  => 'Title',
    'list_prefix'                 => ['text' => 'Signature', 'description' => 'Sortable list-column header for each motion\'s short reference code/prefix (e.g. "A1"), not a person\'s signature.'],
    'list_type'                   => 'Type',
    'list_motion_short'           => 'A',
    'list_amend_short'            => 'ÄA',
    ...
    'list_prop_user_rejected'     => 'The proposer rejected this proposal',
    ...
    'list_functions_tags_add'     => 'Add Tag Column',
    'list_functions_tags_remove'  => 'Remove Tag Column',
    'list_functions_date_add'     => 'Add Date Column',
    'list_functions_date_remove'  => 'Remove Date Column',
    'list_functions_type_add'     => 'Add Type Column',
    'list_functions_type_remove'  => 'Remove Type Column',
    ...
    'filter_proposal_rejected'    => 'Rejected proposals',
    ...
    'filter_prefix'               => ['text' => 'Signature', 'description' => 'Filter field label to search motions by their reference code/prefix (e.g. "A1"), not a person\'s signature.'],
    ...
    'con_url_path'            => ['text' => 'Directory', 'description' => 'Label for the field setting the URL path segment (slug) under which the consultation is reachable, e.g. "mycongress" in site.tld/mycongress; not a file-system folder or a contact directory.'],
    ...
    'con_topics_public'       => 'Motion tags',
    'con_topics_amendment'    => 'Amendment tags',
    ...
    'con_title_multilang'     => 'Multi-language support',
    'con_multilang_activate'  => 'Activate Multi-Language Support (advanced feature)',
    'con_multilang_activate_h' => 'Lets users choose the language they browse this site in, and lets motions/amendments provide content in several languages in parallel.',
    'con_multilang_languages' => 'Available languages',
...
As there is <strong>no e-mail-delivery configured</strong>, it is necessary that you enter the passwords for the users here and send the passwords to them manually.<br><br>' .
    ...
    'motion_type_supp_person_type' => 'Allowed to support',
    ...
    'motion_section_language'       => 'Language',
    'motion_section_language_all'   => 'All languages',
    'motion_section_language_group' => 'Language group',
    'motion_section_language_group_p' => 'e.g. body',
    'motion_section_language_group_h' => 'Sections sharing the same language group are translations of each other and belong to the same field, just in a different language.',
    'motion_section_language_warn_no_group' => 'The section "%SECTION%" has a language set, but no language group, so it will not be recognized as a translation of any other section.',
    'motion_section_language_warn_duplicate' => 'The language group "%GROUP%" has more than one section in the same language.',
    'motion_section_language_warn_mixed_types' => 'The language group "%GROUP%" mixes sections of different types.',
    ...
    'motion_cdeadline_amend2amend' => 'Times for amendments to amendments (falls back to the amendments deadline if left empty)',
    ...
    'removeAdminConfirm' => [
        'text' => 'Do you really want to remove admin right from this user?',
        'js' => true,
    ],
    'removeUserConfirm' => [
        'text' => 'Do you really want to remove the user %NAME% from THIS consultation? Submitted motions etc. will remain in the system and need to be removed manually.',
        'js' => true,
    ],
    'deleteUserConfirm' => [
