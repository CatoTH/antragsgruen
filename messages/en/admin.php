...
As there is <strong>no e-mail-delivery configured</strong>, it is necessary that you enter the passwords for the users here and send the passwords to them manually.<br><br>' .
    ...
    'translating_supported'       => 'Selectable languages',
    'translating_supported_h'     => 'If more than one language is selected here, users can choose the language they want to browse this site in. Motion types can then provide separate sections per language.',
