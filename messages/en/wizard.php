...
return [
    ...
    'single_mot_desc'  => 'If there is only one, there will be no separate home page',
    'single_man_desc'  => 'If there is only one, there will be no separate home page',
    'single_one'       => 'Only one',
    'single_multi'     => 'More than one',

    'motwho_mot_title' => 'Who is allowed to submit motions?',
    'motwho_man_title' => 'Who is allowed to submit chapters?',
    'motwho_admins'    => 'Admins',
    'motwho_loggedin'  => 'Registered users',
    'motwho_all'       => 'Everyone',

    'amendwho_title'    => 'Who is allowed to submit amendments?',
    ...
    'motdead_no'      => 'No',
    'motdead_yes'     => 'Yes:',
    'amenddead_title' => 'Is ethere a deadline for amendments?',
    'amenddead_desc'  => '',
    'amenddead_no'    => 'No',
    'amenddead_yes'   => 'Yes:',
    ...
    'screening_desc'        => 'Should there be a screening process before they are visible to the public?',
    'screening_yes'         => 'Yes',
    'screening_no'          => 'No',
    ...
    'amend_singlepara_desc'   => 'Of not, then an amendment may only propose to change one specific paragraph of the original document.',
    'amend_singlepara_single' => 'Only one passages',
    ...
    'sitedate_desc'           => 'Just some more organisatorical questions...',
