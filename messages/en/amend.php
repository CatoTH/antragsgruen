...
return [
    ...
    'merge1_step3_title'       => 'Handle collissions',
    'merge1_introduction'      => 'Once the changes of this amendment are adopted, a new version of the motion includung these changes is created. The original version and this amendment will be kept for reference.<br><br>If adopting this amendment makes other amendments superfluous, please mark them as such.<br><br><strong>Hint:</strong> if this changes parts of the motion that are affected by other amendments as well, a collission occurs. In that case, you need to edit those amendments to reflect the changes made in the base motion.',
    'merge1_status_intro'      => 'If other amendments are made superfluous by this change (e.g. if they were covered by this amendment or rejected in favor of this one), you can mark them as such.<br>Amendments marked as rejected or adopted (modified) here do not lead to collissions.',
    'merge1_collission_intro'  => '<strong>There is a collission with an amendment</strong><br><br>The changes made are in conflict with an amendment. You need to edit the affected paragraphs of the amendment manually. Please rewrite the following paragraphs of the amendments to contain the changes made above, but <strong>preserving the meaning of the amendment</strong>.',
    ...
    'merge1_use_modified'      => 'Modifed adoption',
    'merge1_modify_title'      => 'Modify the amendment',
    'merge1_check_collissions' => 'Next / Check for collissions',
    'merge1_other_status'      => 'New stati of the other amendments',
    ...
    'merge1_no_collissions'    => 'No conflict with any other amendment',
    'merge1_manual_changes'    => 'Changes made by you right now',
    'merge1_manual_amend'      => 'Changes made by the conflicting amendment',
    'merge1_manual_new'        => 'New version of the conflicting amendment',
];
