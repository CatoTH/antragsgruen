...
return [
    ...
    'statute_legend_nested'  => 'Nested markings show where this amendment changes what %PREFIX% proposes – for example text that %PREFIX% wants to delete and that is being restored here.',
    ...
    'merge_amtable_text_orig'      => [
        'text' => 'Original amendment',
        'js' => true,
    ],
    'merge_amtable_text_prop'      => [
        'text' => 'Proposed procedure',
        'js' => true,
    ],
    ...
    'merge_new_votes_comment'      => [
        'text' => 'Voting result comment',
        'js' => true,
    ],
    'merge_voting_set'             => [
        'text' => 'Voting result',
    ...
    'merge_amend_votes_yes'        => [
        'text' => 'Yes',
        'js' => true,
    ],
    'merge_amend_votes_no'         => [
        'text' => 'No',
        'js' => true,
    ],
    'merge_amend_votes_abstention' => [
        'text' => 'Abst.',
        'js' => true,
    ],
    'merge_amend_votes_invalid'    => [
        'text' => 'Invalid',
        'js' => true,
    ],
    ...
    'proposal_save_changes_post' => 'Change old version',
