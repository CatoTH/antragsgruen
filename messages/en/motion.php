...
return [
    ...
    'private_notes_para_open'       => '<span class="sr-only">Open</span> Private note to paragraph no. %NO% (%TITLE%) ',
    'private_notes_para_save'       => 'Save private note to paragraph no. %NO% (%TITLE%)',
