...
return [
    ...
    'preset_app_singular'  => ['text' => 'Application', 'description' => 'Preset motion type name for a candidacy/nomination form (e.g. running for a board position), not a software application.'],
    'preset_app_plural'    => ['text' => 'Applications', 'description' => 'Plural of "Application" as in candidacy/nomination submissions, not software applications.'],
    'preset_app_call'      => ['text' => 'Apply', 'description' => 'Call-to-action button to submit a candidacy/nomination ("apply for this"), not "apply changes/settings".'],
    ...
    'preset_app_title_int' => ['text' => 'Application: ', 'description' => 'Prefix label for a candidacy/nomination title, same "Application" as in the preset_app_* candidacy form labels, not a software application.'],
    ...
    'STATUS_REFERRED'                     => ['text' => 'Referred', 'description' => 'Motion status: the motion was forwarded/handed off to another body (e.g. a committee) for decision, not "referred to" in the sense of being mentioned or cited.'],
    'STATUSV_REFERRED'                    => ['text' => 'Refer', 'description' => 'Verb form of STATUS_REFERRED: the action of forwarding a motion to another body for decision, not "refer to/cite".'],
    'STATUS_VOTE'                         => ['text' => 'Vote', 'description' => 'Noun: motion status meaning "up for voting" (German needs the noun form, e.g. "Abstimmung"). Distinct from STATUSV_VOTE below, which is the imperative verb form ("vote on this now") and needs a different grammatical form in most languages, even though the English text is identical.'],
    'STATUSV_VOTE'                        => ['text' => 'Vote', 'description' => 'Imperative verb: action button to start/cast a vote (German needs the verb infinitive, e.g. "Abstimmen"). Distinct from STATUS_VOTE above, which is the noun status label, even though the English text is identical.'],
    ...
    'PROPOSED_REFERRED'           => ['text' => 'Referred', 'description' => 'Recommended-procedure label: the recommendation is to forward/hand off the motion to another body (e.g. a committee) for decision, not "referred to" in the sense of being mentioned or cited.'],
    'PROPOSED_VOTE'               => 'Vote',
