...
return [
    ...
    'err_update_mode'       => 'The site is in maintenance mode due to an update.<br><br>If you are the admin and this is not intentional, you can find further information in the <a href="https://github.com/CatoTH/antragsgruen/blob/v3/docs/update-troubleshooting.md">documentation</a>.',
