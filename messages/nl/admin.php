...
return [
    ...
    'bread_admin'                 => 'Administratie',
    'bread_list'                  => 'voorstellijst',
    'bread_amend'                 => 'Amenedment',
    ...
    'saved'                       => 'Opgeslagen.',
    'save'                        => 'Opslaan',
    'index_title'                 => 'Administratie',
    'index_motions'               => 'voorstellen / documenten',
    'index_all_motions'           => 'Alle voorstellen en amendementen',
    'index_export_ods'            => 'Spreadsheet',
    'index_export_ods_short'      => 'Spreadsheet: <small>kort amendement.</small>',
    'index_export_ods_tt'         => 'Spreadsheets kunnen onder andere geopend worden met OpenOffice, LibreOffice en Google Docs',
    'index_export_procedure'      => 'Voorgestelde procedure',
    'index_export_ods_listall'    => 'Spreadsheet: voorstellen, addresses',
    'index_export_comments_xlsx'  => 'Comments (Excel)',
    'index_motion_create'         => 'Maak nieuwe',
    'index_export_excel'          => 'Exporteer: excel',
    'index_export_oslides'        => 'OpenSlides exporteren',
    'index_export_oslides_users'  => 'Deelnemers',
    'index_export_oslides_usersh' => '(moet eerst geïmporteerd worden op OpenSlides)',
    'index_export_oslides_amend'  => 'Amendmenten',
    'index_error_prone'           => 'error-prone',
    'index_amendments'            => 'Amendmenten',
    'index_motion_export'         => 'Exporteer',
    'index_pdf_collection'        => 'All-In-One PDF',
    'index_pdf_list'              => 'Lijst van alle PDFs',
    'index_pdf_zip_list'          => 'ZIP archief van alle PDFs',
    'index_odt_zip_list'          => 'ZIP archiief van alle ODTs',
    'index_odt_allmot'            => 'Een ODT met alle voorstellen',
    'index_settings'              => 'Instellingen',
    'index_appearance'            => 'Uiterlijk en onderdelen van deze site',
    'index_consultation_settings' => 'Deze raadpleging',
    'index_motion_types'          => 'Pas voorsteltypes aan',
    'index_site_voting'           => 'Votings',
    'index_site_speaking'         => 'Speaking lists',
    'index_site_access'           => 'Inloggen / gebruikers / beheerders',
    'index_site_consultations'    => 'Beheer meerdere raadplegingen op dit subdomein',
    'index_site_config'           => 'Configuratie van deze Motion Tools installatie',
    'index_site_user_list'        => 'Geregistreerde gebruikers',
    'index_sys_admin'             => 'Systeemconfiguratie',
    'index_flush_caches'          => 'Systeemcache spoelen',
    'index_flushed_cached'        => 'Alle caches zijn gespoeld',
    'index_todo'                  => 'To Do',
    'index_todo_motions'          => 'Toon To Do\'s in voorstellen lijst',
    'index_todo_none'             => 'No entries',
    'index_site_del'              => 'Verwijder site',
    'index_pages'                 => 'Inhoudpaginas',
    'amend_deleted'               => 'Het amendement is verwijderd.',
    'amend_screened'              => 'Het amendement is goedgekeurd.',
    'amend_prefix_collision'      => 'De ingevoerde prefix is al in gebruik door een ander amendement.',
    'motion_prefix_collision'     => 'De ingevoerde prefix is al in gebruik door een andere voorstel.',
    'motion_deleted'              => 'Het voorstel is verwijderd.',
    'motion_screened'             => 'Het voorstel is goedgekeurd.',
    'motion_edit_text'            => 'Pas tekst aan',
    'motion_edit_text_warn'       => '<strong>Waarschuwing:</strong> Pas liever geen teksten meer aan, als er al commentaar is gegeven of amendementen zijn geschreven.',
    'motion_edit_btn'             => 'Aanpassen',
    'motion_edit_supporters'      => 'Ondersteuners',
    'motion_edit_supporters_add'  => 'Voeg ondersteuner toe',
    'motion_edit_title'           => 'Pas voorstel aan',
    ...
    'con_show_ad'             => 'Show &quot;Using Motion Tools&quot; in the sidebar',
    ...
    'con_multilang_activate_h' => 'Hiermee kunnen gebruikers de taal kiezen waarin ze deze site bekijken, en kunnen moties/amendementen inhoud in meerdere talen tegelijk bevatten.',
...
If this site should only be <em>visible</em> to users included below, select the settings immediately below the reference. If the site should be visible to all but only registered users can submit motions, then you can set this automatically here:',
    ...
    'siteacc_useraccounts'      => 'Standard Motion Tools accounts <small>(everyone with a valid e-mail address)</small>',
...
we have just created an Motion Tools account for you. Now you can join the discussion on the motions / drafts.
...
As there is <strong>no e-mail-delivery configured</strong>, it is necessary that you enter the passwords for the users here and send the passwords to them manually.<br><br>' .
                                   'However, for <strong>privacy reasons</strong> it would be more advisible to configure the e-mail-delivery and let Motion Tools create the passwords internally and send the passwords to the users automatically.',
    ...
    'translating_hint'            => 'Here you can change all texts of the user interface of Motion Tools. If you want to completely translate Motion Tools into another language, please <a href="https://github.com/CatoTH">contact us</a> so we can adopt the translation into the official project.<br>' .
    ...
    'motion_type_supp_person_type' => 'Mogen ondersteunen',
    ...
    'php_version_hint_text'  => 'This server runs the obsolete version %CURR% or PHP. Future versions of Motion Tools will not be compatible with it. Please upgrade PHP soon.',
