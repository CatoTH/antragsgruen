...
test.describe('Amendments: StatuteAmendmentsAgenda', () => {
    ...
    test('activate statute amendments and create two base statutes', async ({ page }) => {
        ...
        await page.locator('#typeMotionPrefix').fill('ST');
        await page.locator('#typeTitleSingular').fill('Statute amendment');
        await page.locator('#typeTitlePlural').fill('Statute amendments');
        await page.locator('#typeCreateTitle').fill('Create a statute amendment');
    ...
    test('see the new amendment being assigned to the agenda item', async ({ page }) => {
        await expect(
            page.locator(
