...
test.describe('EditingMotionsAfterParagraphComments', () => {
    ...
    test('enable paragraph-based comments, write a comment, edit the motion', async ({ page }) => {
        ...
        await page.locator('.section2 .commentParagraph input').check();
        ...
        await expect(page.locator('#section_2_5 .commentForm')).toBeVisible();
        await page.locator('#comment_2_5_text').fill("My test'\n\\My test 2");
        ...
        await page.locator('#motionTitle').fill('My new title');
