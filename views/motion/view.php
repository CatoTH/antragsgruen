...
$hasPpAdminbox = ($hasPp && !$motion->isResolution() && User::havePrivilege($consultation, Privileges::PRIVILEGE_CHANGE_PROPOSALS));
...
if ($commentWholeMotions && $maySeeComments && !$motion->isResolution() && !$alternativeCommentView) {
    ...
    $form           = $commentForm;
    $screeningAdmin = User::havePrivilege($motion->getMyConsultation(), Privileges::PRIVILEGE_SCREENING);
