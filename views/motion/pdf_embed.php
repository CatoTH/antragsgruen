...
<head>
    ...
    <link rel="stylesheet" href="<?=$pdfjsPath?>viewer.css"/>
    <!--#if !PRODUCTION-->
    ...
    <script src="<?=$pdfjsPath?>download_manager.js"></script>
    <script src="<?=$pdfjsPath?>view_history.js"></script>
    <script src="<?=$pdfjsPath?>pdf_link_service.js"></script>
    <script src="<?=$pdfjsPath?>pdf_rendering_queue.js"></script>
    <script src="<?=$pdfjsPath?>pdf_page_view.js"></script>
    <script src="<?=$pdfjsPath?>text_layer_builder.js"></script>
    <script src="<?=$pdfjsPath?>annotations_layer_builder.js"></script>
    <script src="<?=$pdfjsPath?>pdf_viewer.js"></script>
    <script src="<?=$pdfjsPath?>pdf_thumbnail_view.js"></script>
    <script src="<?=$pdfjsPath?>pdf_thumbnail_viewer.js"></script>
    <script src="<?=$pdfjsPath?>pdf_outline_view.js"></script>
    <script src="<?=$pdfjsPath?>pdf_attachment_view.js"></script>
    <script src="<?=$pdfjsPath?>pdf_find_bar.js"></script>
    <script src="<?=$pdfjsPath?>pdf_find_controller.js"></script>
    <script src="<?=$pdfjsPath?>pdf_history.js"></script>
    <script src="<?=$pdfjsPath?>secondary_toolbar.js"></script>
    <script src="<?=$pdfjsPath?>pdf_presentation_mode.js"></script>
    <script src="<?=$pdfjsPath?>grab_to_pan.js"></script>
    <script src="<?=$pdfjsPath?>hand_tool.js"></script>
