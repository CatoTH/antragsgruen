...
- An optional mechanism for background job execution is introduced, making it possible to send e-mails synchronously (therefore not blocking regular requests).
