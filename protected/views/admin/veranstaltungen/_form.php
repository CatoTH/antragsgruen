...
<div class="well">
	<div class="content">
		...
		<div>
			<label for="VeranstaltungsEinstellungen_zeilenlaenge">Maximale Zeilenlänge</label>			<div style="display: inline-block; width: 420px;">
				<input id="VeranstaltungsEinstellungen_zeilenlaenge" name="VeranstaltungsEinstellungen[zeilenlaenge]" type="number" value="<?=$einstellungen->zeilenlaenge?>">				<br>
