...
<div class="content">
	...
	<fieldset style="margin-top: 10px;">
		<label class="block"><input type="checkbox" name="antrag_neu_nur_namespaced_accounts"
	...
	<fieldset style="margin-top: 10px;">
		<label class="block"><input type="checkbox" name="antrag_neu_nur_wurzelwerk" value="1"
