...
INSERT INTO veranstaltung SELECT id, id, name, name_kurz, datum_von, datum_bis, antragsschluss, policy_antraege, policy_aenderungsantraege, policy_kommentare, policy_unterstuetzen, typ, yii_url, admin_email, einstellungen FROM antragsgruen_alt.veranstaltung;
