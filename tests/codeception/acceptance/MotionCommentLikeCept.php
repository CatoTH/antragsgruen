...
$I->dontSeeElement('.commentSupporterHolder');


$I->wantTo('Activate comment ratings');
$I->loginAsStdAdmin();
$I->click('#adminLink');
$I->click('#consultationextendedLink');
$I->checkOption('#commentsSupportable');
...
$I->see('My Name', '#section_3_1 .motionComment');
$I->see('Some Text', '#section_3_1 .motionComment');
$I->seeElement('.commentSupporterHolder');
$I->submitForm('.commentSupporterHolder', [], 'commentLike');
*/