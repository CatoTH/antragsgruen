...
$I->click('.filterResponsibility .dropdown-toggle');
$I->dontSee('Proposal Admin', '.filterResponsibility .dropdown-menu');
$I->see('Single-Consultation Admin (1)', '.filterResponsibility .dropdown-menu');
$I->executeJS('$(".filterResponsibility [data-value=7] a").click();');
