...
$I->checkOption('#proposedChanges .proposalStatus' . IMotion::STATUS_CUSTOM_STRING);
...
$selected = $I->executeJS('return $("#proposedChanges input[name=newVersion]:checked").val();');
$I->assertEquals('new', $selected);
...
$I->click('#proposedChanges .version1');
$I->seeInField('#proposedChanges input[name=proposalStatus]', (string)IMotion::STATUS_CUSTOM_STRING);
