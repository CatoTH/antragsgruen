...
$userPaths            .= '|emailblocklist|recovery|myaccount|emailchange|data-export|setlanguage';
...
$urlRules = [
    ...
    $restBaseCon . '/motion/<motionSlug:[^\/]+>/support'                             => '/rest/motion/support',
    $restBaseCon . '/motion/<motionSlug:[^\/]+>/screen'                              => '/rest/motion/screen',
    $restBaseCon . '/motion/<motionSlug:[^\/]+>/amendment/<amendmentId:\d+>'         => '/rest/amendment/get',
    ...
    $restBaseCon . '/speech/<queueIds:[^\/]+>/admin'                                 => '/rest/speech/get-queue-admin',
    $restBaseCon . '/speech/<queueId:[^\/]+>/admin/settings'                         => '/rest/speech/post-queue-settings',
    $restBaseCon . '/speech/<queueId:[^\/]+>/admin/reset'                            => '/rest/speech/admin-queue-reset',
    $restBaseCon . '/speech/<queueId:[^\/]+>/admin/randomize'                        => '/rest/speech/admin-queue-randomize',
    $restBaseCon . '/speech/<queueId:[^\/]+>/admin/item'                             => '/rest/speech/admin-create-item',
    $restBaseCon . '/speech/<queueId:[^\/]+>/admin/item/<itemId:[^\/]+>/<op:[^\/]+>' => '/rest/speech/post-item-operation',
    ...
    $restBaseCon . '/votings/open' => '/rest/voting/get-open-voting-blocks',
    $restBaseCon . '/votings/closed' => '/rest/voting/get-closed-voting-blocks',
    $restBaseCon . '/votings/admin' => '/rest/voting/get-admin-voting-blocks',
    $restBaseCon . '/votings/create' => '/rest/voting/create-voting-block',
    $restBaseCon . '/votings/sort' => '/rest/voting/post-vote-order',
    $restBaseCon . '/votings/<votingBlockId:[^\/]+>/settings' => '/rest/voting/post-vote-settings',
    $restBaseCon . '/votings/<votingBlockId:[^\/]+>/vote' => '/rest/voting/post-vote',
