...
$consultationPaths    .= '|resolutions|motions|todo|votings|voting-results|feeds|feedall|feedmotions|feedamendments|feedcomments';
...
$userPaths            = 'login|logout|token|confirmregistration|emailblocklist|recovery|myaccount|emailchange|data-export';
...
$adminAmendmentPaths  = 'excellist|odslist|odslist-short|xslx-list|pdflist|pdfziplist|odtziplist|openslides';
